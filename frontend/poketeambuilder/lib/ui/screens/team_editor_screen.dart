...
import 'package:poketeambuilder/ui/screens/tabs/team_editor.dart';
...
class TeamEditorScreen extends StatefulWidget {
  ...
  @override
  _TeamEditorScreenState createState() => _TeamEditorScreenState();
}
          ...
          child: DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs: [
                    Tab(
                      height: 75,
                      text: ' T E A M  E D I T O R  (${widget.selectedTeam.name} - ${widget.selectedTeam.trainer.username})',
              ...
              body: Center(
                child: TabBarView(
                  children: [
                    TeamEditor(currentTrainer: widget.currentTrainer, selectedTeam: widget.selectedTeam,)
                  ],
                ),
              ),
            ),
